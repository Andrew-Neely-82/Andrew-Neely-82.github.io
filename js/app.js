...
(() => {
  const form = {
    html: `
            ...
            <span style="text-align: center; font-size: large; margin-bottom: 1rem; color: yellow">Updating the form below soon!</span>
            <span style="text-align: center; font-size: large; margin-bottom: 1rem; color: yellow">Please use Linkedin button above in Home section</span>
            <form action="${email}">
              <div class="input-box">
